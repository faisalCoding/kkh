<div class="flex justify-center mt-10">
    <div class="w-10/12 flex flex-col justify-center">
        ...
        <div class="">
            <h1 class="text-gray-800 text-xl py-3 ">__("Department Name")</h1>
        ...
        <div class="">
            <h1 class="text-gray-800 text-xl py-3 ">__("Section description")</h1>
        ...
        <div class="">
            <h1 class="text-gray-800 text-xl py-3 ">__("Section Manager")</h1>
        ...
        <div class="flex flex-col">
            <h1 class="text-gray-800 text-xl py-3 ">__("Section picture")</h1>

            <form class="h-96" wire:submit.prevent="saveFile" class="flex flex-col">
                <input type="file" wire:model="file" class="custom-file-input">
                <div wire:loading wire:target="file" class="text-xl text-yellow-500 block">__("Loading image")</div>
                @if ($file)
                <div class="py-3 text-lg text-gray-700 ">__("image name:") {{ $new_section_image_name }}</div>
                <div class="py-3 text-lg text-gray-700 ">__("Image preview")</div>
        ...
        <div class="py-2">
            <button
                ...
                wire:click="addNewSection">__("add")</button>
        </div>
